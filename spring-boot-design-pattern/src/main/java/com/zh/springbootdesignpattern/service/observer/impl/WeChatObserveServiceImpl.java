 ...
 */
@Slf4j
@Service("weChatObserverService")
public class WeChatObserveServiceImpl implements OrderObserverService, ApplicationListener<OrderEvent> {
    ...
    public void onApplicationEvent(OrderEvent orderEvent) {
        log.info("发送微信通知运营专员,订单号:{}的订单已创建!",orderEvent.getOrderNum());
    }
}
